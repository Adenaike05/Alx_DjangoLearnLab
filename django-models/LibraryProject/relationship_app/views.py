...
def admin_view(request):
    ...
    return render(request, 'admin_view.html', {'user_role': request.user.userprofile.role})
...
def librarian_view(request):
    ...
    return render(request, 'librarian_view.html', {'user_role': request.user.userprofile.role})
...
def member_view(request):
    ...
    return render(request, 'member_view.html', {'user_role': request.user.userprofile.role})
